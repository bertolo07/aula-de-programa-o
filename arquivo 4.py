...
botao_potência=tk.Button(janela, text="**",command=lambda:inserir_texto("**"),width=13, height=4,font=("Arial",12))
botao_potência.grid(column=1,row=6)
botao_raíz=tk.Button(janela, text="^1/2",command=lambda:inserir_texto("^1/2"),width=13, height=4,font=("Arial",12))
botao_raíz.grid(column=2,row=6)
botao_fração=tk.Button(janela, text="*1/x",command=lambda:inserir_texto("1/x"),width=13, height=4,font=("Arial",12))
botao_fração.grid(column=3,row=6)
